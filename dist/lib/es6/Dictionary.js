...
var Dictionary = /** @class */ (function () {
    ...
    Dictionary.from = function (bytes) {
        ...
        while (!tokenizer.complete) {
            var key = findDictionaryKey(tokenizer);
            var value = findDictionaryValue(tokenizer);
...
export { Dictionary };
export var findDictionaryKey = function (tokenizer) {
    var name = "";
    while (!name) {
...
export var findDictionaryValue = function (tokenizer) {
